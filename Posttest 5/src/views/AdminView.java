...
public class AdminView {
    ...
    private void editFilmMenu() {
        ...
        String judul = InputUtils.getStringInputV2("Judul baru (kosongkan jika tidak diubah): ");
        String genre = InputUtils.getStringInputV2("Genre baru (kosongkan jika tidak diubah): ");
        String durasiStr = InputUtils.getStringInputV2("Durasi baru (menit, kosongkan jika tidak diubah): ");
        String sinopsis = InputUtils.getStringInputV2("Sinopsis baru (kosongkan jika tidak diubah): ");
    ...
    private void editScheduleMenu() {
        ...
        String dateStr = InputUtils.getStringInputV2("Tanggal baru (dd/MM/yyyy, kosongkan jika tidak diubah): ");
        String timeStr = InputUtils.getStringInputV2("Waktu baru (HH:mm, kosongkan jika tidak diubah): ");
        String hargaStr = InputUtils.getStringInputV2("Harga baru (kosongkan jika tidak diubah): ");
